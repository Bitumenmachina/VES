...
dependencies: Node 24 (global `WebSocket` + `fetch`) drives headless Chrome over
raw CDP.
...
- Canonical reference build: `~/Downloads/VES.html`,
...
Headless Chrome 149 + raw CDP over Node's built-in WebSocket. No npm installs. Harness
