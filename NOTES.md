...
- **Q2 LANDED — 2.1.0-rc.2** (2026-09-15). sha256 `72151ced160d0627153e37f6d573ff7388c507d635ca05b2ce712d03203b54fc`. Hide/solo strip, chip, keys, region eye; screen-only. probe-hide 8/8.
  R-12a: hidden regions must be recoverable → Q3-0.
- **Q3 LANDED — 2.1.0-rc.3** (2026-09-15, e7aa796). sha256 `c56aea25dc482aabe62b45123a0bb796457b3aa9ed2591371eed41b4d49f4ca8`. Selection chip + doors, selectedIds,
...
- **Q4 LANDED — 2.1.0-rc.5** (2026-09-15, 4daf8c2). md5 `9155cd3c`. Ten of eleven doors (scale offer, Shift+L labels, ortho lock, card ⋮ menu with Duplicate + Type a
  ...
  rc.5 PUSHED on the standing word → origin/main `56db1fc`, CI run 35044897522 GREEN.
- **Q6 LANDED — 2.1.0-rc.6** (2026-09-15, 85efec4). md5 `0d055e3e`. M-1 CEIL default + per-line CEIL/EXACT/NEAREST override · M-2 Overhead named on every face
